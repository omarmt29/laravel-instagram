...
<div class="container m-auto">
    ...
    <form class="max-w-xl m-auto" method="POST" action="{{ route('register') }}">
        @csrf

        <div class="relative z-0 w-full mb-6 group text-black">
            <input type="email" name="email" value="{{ old('email') }}" value="{{ old('name') }}" id="floating_email" class="@error('email') is-invalid @enderror block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="relative z-0 w-full mb-6 group text-black">
            <input type="password" name="password_confirmation" type="password" autocomplete="new-password" id="floating_password" class=" @error('password') is-invalid @enderror block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-white dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Password</label>
        </div>
